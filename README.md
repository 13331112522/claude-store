...
| **mind-transposition** | Transfer your AI agent's personality, skills, memory, and soul across platforms. Supports Claude Code, OpenClaw, Nanobot, and Hermes agents. Export agent mind to GitHub with intelligent cross-platform file mapping, backup protection, and secret detection. Clone agent setups or backup personality configurations with version history |
